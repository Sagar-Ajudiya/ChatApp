package com.codesoft.whatsapp.adapter
...
import com.codesoft.whatsapp.R
import com.codesoft.whatsapp.databinding.ReceiverItemLayoutBinding
import com.codesoft.whatsapp.databinding.SentItemLayoutBinding
...
class MessageAdapter(var context : Context, var list : ArrayList<MessageModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        else ReciverViewHolder(LayoutInflater.from(context).inflate(R.layout.receiver_item_layout,parent,false))
    }
